<!-- Generated from CONTRIBUTING.md by scripts/docs-project-pages.py; edit that file instead. -->
...
- **Read [docs/ARCHITECTURE.md](https://github.com/PndaMan/delune/blob/main/docs/ARCHITECTURE.md)** — ten minutes that save hours.
- **Check the [roadmap](https://github.com/PndaMan/delune/blob/main/docs/ROADMAP.md) and open issues.** For anything bigger than
  a bug fix, open an issue first so we can agree on the approach.
- **Decisions that change the architecture need an ADR** in [docs/adr/](https://github.com/PndaMan/delune/tree/main/docs/adr).
