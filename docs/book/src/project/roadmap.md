<!-- Generated from docs/ROADMAP.md by scripts/docs-project-pages.py; edit that file instead. -->

# Roadmap

Plans change; this file tracks the current intent. Product decisions behind it are
in [DECISIONS.md](https://github.com/PndaMan/delune/blob/main/docs/DECISIONS.md) and [adr/](https://github.com/PndaMan/delune/tree/main/docs/adr).
